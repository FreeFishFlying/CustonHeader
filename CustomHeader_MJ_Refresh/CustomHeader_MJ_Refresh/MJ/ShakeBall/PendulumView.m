...
static const CGFloat ballSize = 8;
...
#define BLUE   [UIColor colorWithRed:127/255.0f green:172/255.0f blue:255.0f/255.0f alpha:1]
#define GREEN [UIColor colorWithRed:118/255.0f green:220/255.0f blue:130/255.0f alpha:1]
#define YELLOW [UIColor colorWithRed:255/255.0f green:198/255.0f blue:0/255.0f alpha:1]
#define PINK  [UIColor colorWithRed:255/255.0f green:111/255.0f blue:179/255.0f alpha:1]
#define RED  [UIColor colorWithRed:253/255.0f green:115/255.0f blue:115/255.0f alpha:1]
...
- (void)createBalls
{
    ...
    self.colorArray = [NSArray arrayWithObjects:BLUE ,GREEN,YELLOW,PINK,RED, nil];
    ...
    for (int i = 0; i < ballCount; i++)
    {
        ...
        ball.backgroundColor = [self.colorArray objectAtIndex:i];
...
- (void)createReflection
{
    ...
    for (int i = 0; i < ballCount; i++)
    {
        ...
        reflectionBall.backgroundColor = [self.colorArray objectAtIndex:i];
...
- (UIView *)ball
{
    UIImageView *ball = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, ballSize, ballSize)];
